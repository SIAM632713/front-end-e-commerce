...
const OrderSummary = () => {
    ...
    return (
        <div className="bg-pink-100 p-4 sm:p-6 rounded-lg shadow-sm w-full mx-auto mt-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                <button
                    onClick={Handleclear}
                    className="bg-red-500 text-white px-4 py-2 rounded-md text-sm flex items-center justify-center gap-2 hover:bg-red-600 w-full sm:w-auto"
                >
                ...
                <button
                    ...
                    className="bg-green-600 text-white px-4 py-2 rounded-md text-sm flex items-center justify-center gap-2 hover:bg-green-700 w-full sm:w-auto"
                >
